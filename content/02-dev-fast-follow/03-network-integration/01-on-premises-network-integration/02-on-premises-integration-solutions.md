...
See [Planning for AWS Direct Connect]({{< relref "05-planning-for-directconnect" >}}) if you'd like to learn more about getting started with planning to use AWS Direct Connect.
